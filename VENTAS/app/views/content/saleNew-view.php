...
<div class="container pb-6 pt-6">
    ...
    <?php }else{ ?>
        <article class="message is-warning">
            ...
            <div class="message-body has-text-centered"><i class="fas fa-exclamation-triangle fa-2x"></i><br>No hemos podio seleccionar algunos datos sobre la empresa, por favor <a href="<?php echo APP_URL; ?>index.php?views=companyNew/" >verifique aquí los datos de la empresa</div>
        </article>
    <?php } ?>
</div>
