<?php
	...
	class clientController extends mainModel{
		...
		public function registrarClienteControlador(){
		    ...
		    if($this->verificarDatos("[a-zA-Z0-9-]{7,12}",$numero_documento)){
		    	$alerta=[
					"tipo"=>"simple",
					"titulo"=>"Ocurrió un error inesperado",
		    ...
		    if($telefono!=""){
		    	if($this->verificarDatos("[0-9()+]{8,15}",$telefono)){
			    	$alerta=[
						"tipo"=>"simple",
						"titulo"=>"Ocurrió un error inesperado",
				...
				foreach($datos as $rows){
					$tabla.='
						<tr class="has-text-centered" >
			                ...
			                <td>
			                    <a href="'.APP_URL.'index.php?views=clientUpdate/'.$rows['cliente_id'].'/" class="button is-success is-rounded is-small">
