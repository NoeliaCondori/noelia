<?php
	...
	class saleController extends mainModel{
        ...
        public function agregarProductoCarritoControlador(){
            ...
            $alerta=[
				"tipo"=>"redireccionar",
				"url"=>APP_URL."index.php?views=saleNew/"
			];
					...
					$tabla.='
						<tr class="has-text-centered" >
			                ...
			                <td>
			                    ...
			                    <a href="'.APP_URL.'index.php?views=saleDetail/'.$rows['venta_codigo'].'/" class="button is-link is-rounded is-small" title="Informacion de venta Nro. '.$rows['venta_id'].'" >
