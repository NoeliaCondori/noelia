				...
				foreach($datos as $rows){
					$tabla.='
						<tr class="has-text-centered" >
							...
							<td>
			                    <a href="'.APP_URL.'index.php?views=productCategory/'.$rows['categoria_id'].'/" class="button is-info is-rounded is-small">
			                    	<i class="fas fa-boxes fa-fw"></i>
			                    </a>
			                </td>
			                <td>
			                    <a href="'.APP_URL.'index.php?views=categoryUpdate/'.$rows['categoria_id'].'/" class="button is-success is-rounded is-small">
