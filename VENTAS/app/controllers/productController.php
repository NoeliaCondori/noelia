		            ...
		            $tabla.='</p>
		                ...
		                <div class="media-content">
		                    ...
		                    <div class="has-text-right">
		                        <a href="'.APP_URL.'index.php?views=productPhoto/'.$rows['producto_id'].'/" class="button is-info is-rounded is-small">
			                    	<i class="far fa-image fa-fw"></i>
			                    </a>

		                        <a href="'.APP_URL.'index.php?views=productUpdate/'.$rows['producto_id'].'/" class="button is-success is-rounded is-small">
